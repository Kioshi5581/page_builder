...
class Homepage(models.Model):
    ...
    pricing_table = models.ManyToManyField(pricing_table)
    ...
    feature_section_card = models.ManyToManyField(call_to_action)
    reviews_section_title = models.CharField(max_length=200)
    reviews_section_card = models.ManyToManyField(review) 
